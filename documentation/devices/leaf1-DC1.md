...
| Loopback10 | RED_VTEP_DIAGNOSTICS | RED | 10.255.10.1/32 |
| Loopback20 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.20.1/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.100.1:10110 | 10110:10110 | - | - | learned |
| 111 | 192.168.100.1:10111 | 10111:10111 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 192.168.100.1:20 | connected |
| RED | 192.168.100.1:10 | connected |
...
router bgp 65101
   ...
   !
   vlan 110
      rd 192.168.100.1:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 111
      rd 192.168.100.1:10111
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.255.20.1
ip address virtual source-nat vrf RED address 10.255.10.1
```

...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet5 | routed | - | 172.31.200.13/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet5 | routed | - | 172.31.200.15/31 | default | 1500 | False | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 122 | 192.168.200.6:10141 | 10141:10141 | - | - | learned |
| 123 | 192.168.200.6:10142 | 10142:10142 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 192.168.200.6:19 | connected |
| VRF_B | 192.168.200.6:20 | connected |
...
router bgp 65202
   ...
   neighbor 172.31.200.12 description spine1-DC2_Ethernet5
   neighbor 172.31.200.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.200.14 remote-as 65200
   neighbor 172.31.200.14 description spine2-DC2_Ethernet5
   ...
   !
   vlan 122
      rd 192.168.200.6:10141
      route-target both 10141:10141
      redistribute learned
   !
   vlan 123
      rd 192.168.200.6:10142
...
ip address virtual source-nat vrf VRF_B address 10.255.20.6
```

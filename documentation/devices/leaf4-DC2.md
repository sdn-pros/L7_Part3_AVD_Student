...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.0.34/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_L3_LEAF34 | Vlan4094 | 10.255.2.64 | Port-Channel1 |
...
!
mlag configuration
   domain-id DC2_L3_LEAF34
   local-interface Vlan4094
   peer-address 10.255.2.64
...
| Ethernet6 | host2-DC2_E2 | *trunk | *16-17 | *- | *- | 10 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet5 | routed | - | 10.20.0.7/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet5 | routed | - | 10.20.0.39/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet5 | routed | - | 10.20.0.71/31 | default | 9214 | False | - | - |
...
| Port-Channel10 | host2-DC2 | switched | trunk | 16-17 | - | - | - | - | 10 | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.1.33/32 |
...
| Vlan3999 |  tenant-a  |  10.255.3.65/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.3.65/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.2.65/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.20.0.6 | 65220 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.20.0.38 | 65220 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.20.0.70 | 65220 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.3.64 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.3.64 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | tenant-a | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 16 | 192.168.255.34:10016 | 10016:10016 | - | - | learned |
| 17 | 192.168.255.34:10017 | 10017:10017 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| tenant-a | 192.168.255.34:1000 | connected |
...
router bgp 65234
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65234
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf3-DC2
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.20.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.6 remote-as 65220
   neighbor 10.20.0.6 description spine1-DC2_Ethernet5
   neighbor 10.20.0.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.38 remote-as 65220
   neighbor 10.20.0.38 description spine2-DC2_Ethernet5
   neighbor 10.20.0.70 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.70 remote-as 65220
   neighbor 10.20.0.70 description spine3-DC2_Ethernet5
   neighbor 10.255.3.64 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.3.64 description leaf3-DC2
   ...
   !
   vlan 16
      rd 192.168.255.34:10016
      route-target both 10016:10016
      redistribute learned
   !
   vlan 17
      rd 192.168.255.34:10017

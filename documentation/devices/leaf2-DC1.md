...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet3 | routed | - | 172.31.100.5/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet3 | routed | - | 172.31.100.7/31 | default | 1500 | False | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.255.4:10129 | 10129:10129 | - | - | learned |
| 111 | 192.168.255.4:10130 | 10130:10130 | - | - | learned |
...
router bgp 65101
   ...
   neighbor 172.31.100.4 description spine1-DC1_Ethernet3
   neighbor 172.31.100.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.100.6 remote-as 65100
   neighbor 172.31.100.6 description spine2-DC1_Ethernet3
   ...
   !
   vlan 110
      rd 192.168.255.4:10129
      route-target both 10129:10129
      redistribute learned
   !
   vlan 111
      rd 192.168.255.4:10130

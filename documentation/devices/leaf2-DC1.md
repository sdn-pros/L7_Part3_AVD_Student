...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF12 | Vlan4094 | 10.255.2.40 | Port-Channel1 |
...
| Ethernet6 | host1-DC1_E2 | *trunk | *16-17 | *- | *- | 10 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet3 | routed | - | 10.10.0.3/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet3 | routed | - | 10.10.0.35/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC1_Ethernet3 | routed | - | 10.10.0.67/31 | default | 9214 | False | - | - |
...
| Vlan3999 |  tenant-a  |  10.255.3.41/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.3.41/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.2.41/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.10.0.2 | 65110 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.10.0.34 | 65110 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.10.0.66 | 65110 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.3.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.3.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | tenant-a | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| tenant-a | 192.168.255.22:1000 | connected |
...
router bgp 65012
   ...
   neighbor 10.10.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.0.2 remote-as 65110
   neighbor 10.10.0.2 description spine1-DC1_Ethernet3
   neighbor 10.10.0.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.0.34 remote-as 65110
   neighbor 10.10.0.34 description spine2-DC1_Ethernet3
   neighbor 10.10.0.66 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.0.66 remote-as 65110
   neighbor 10.10.0.66 description spine3-DC1_Ethernet3
   neighbor 10.255.3.40 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.3.40 description leaf1-DC1

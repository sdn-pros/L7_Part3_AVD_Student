...
| --------- | --------------- | ------------ | --------- |
| DC2_LEAF2 | Vlan4094 | 10.255.251.5 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet4 | routed | - | 172.31.200.9/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet4 | routed | - | 172.31.200.11/31 | default | 1500 | False | - | - |
...
| Loopback10 | VRF_A_VTEP_DIAGNOSTICS | VRF_A | 10.255.10.5/32 |
| Loopback20 | VRF_B_VTEP_DIAGNOSTICS | VRF_B | 10.255.20.5/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan122 | VRF_A_VLAN_122 | VRF_A | - | False |
| Vlan123 | VRF_B_VLAN_123 | VRF_B | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan122 |  VRF_A  |  -  |  10.1.22.1/24  |  -  |  -  |  -  |  -  |
| Vlan123 |  VRF_B  |  -  |  10.1.23.1/24  |  -  |  -  |  -  |  -  |
...
!
interface Vlan122
   description VRF_A_VLAN_122
   no shutdown
   vrf VRF_A
   ip address virtual 10.1.22.1/24
!
interface Vlan123
   description VRF_B_VLAN_123
   no shutdown
   vrf VRF_B
...
interface Vxlan1
   ...
   vxlan udp-port 4789
   vxlan vlan 122 vni 10141
   vxlan vlan 123 vni 10142
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 122 | 192.168.200.5:10141 | 10141:10141 | - | - | learned |
| 123 | 192.168.200.5:10142 | 10142:10142 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 192.168.200.5:19 | connected |
| VRF_B | 192.168.200.5:20 | connected |
...
router bgp 65202
   ...
   !
   vlan 122
      rd 192.168.200.5:10141
      route-target both 10141:10141
      redistribute learned
   !
   vlan 123
      rd 192.168.200.5:10142
...
ip address virtual source-nat vrf VRF_B address 10.255.20.5
```

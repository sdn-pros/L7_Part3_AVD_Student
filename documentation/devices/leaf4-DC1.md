...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet5 | routed | - | 192.168.103.13/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet5 | routed | - | 192.168.103.15/31 | default | 1500 | False | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 112 | 192.168.100.4:10112 | 10112:10112 | - | - | learned |
| 113 | 192.168.100.4:10113 | 10113:10113 | - | - | learned |
...
router bgp 65102
   ...
   neighbor 192.168.103.12 description spine1-DC1_Ethernet5
   neighbor 192.168.103.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.14 remote-as 65100
   neighbor 192.168.103.14 description spine2-DC1_Ethernet5
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 112
      rd 192.168.100.4:10112
      route-target both 10112:10112
      redistribute learned
   !
   vlan 113
      rd 192.168.100.4:10113
